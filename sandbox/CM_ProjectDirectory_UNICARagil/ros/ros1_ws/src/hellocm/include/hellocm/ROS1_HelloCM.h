...
#include <hellocm_msgs/IPGDriverPose.h>
#include <hellocm_msgs/IPGDriverTrajectory.h>
...
namespace hellocm
{
    ...
    const std::string node_version      =  "0.9.0.1";                       /*!< String version of this interface
                                                                               - e.g. <Major>.<Minor>.<Patch> */
    const int node_numver               =  901;                           /*!< Numerical version of this interface
