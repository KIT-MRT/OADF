...
MODEL		= UNICARSteer
WRAPPER		= UNICARSteer_wrap
CLASS		= Steering
DESCRIPTION	= "UNICARSteer"
MAINMODEL	= ""
PARAMID		= 1
SYMBOLS		= ""
...
SRCS		= UNICARSteer_capi.c UNICARSteer_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
...
INC_CFLAGS	+= -I$(subst \,/,"C:\Users\Tobias\Documents\Git\cm-ap24\src_cm4sl\UNICARSteer_CarMaker_rtw")
