...
MODEL		= UNICARBrake
WRAPPER		= UNICARBrake_wrap
CLASS		= Brake
DESCRIPTION	= "UNICARBrake"
MAINMODEL	= ""
PARAMID		= 1
SYMBOLS		= ""
...
SRCS		= UNICARBrake_capi.c UNICARBrake_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
...
INC_CFLAGS	+= -I$(subst \,/,"C:\Users\Tobias\Documents\Git\cm-ap24\src_cm4sl\UNICARBrake_CarMaker_rtw")
